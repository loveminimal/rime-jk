--[[ 
keep_short_code_first_tiger: 保持虎码的一、二级简码对应的汉字在候选列表首位
...
local secondary_code_table = {
    ...
    -- 第二十二行（B 开头）
    ["ba"] = "妹", ["bb"] = "妇", ["bc"] = "姑", ["bd"] = "强", ["be"] = "她", ["bf"] = "姐", ["bg"] = "弓", ["bh"] = "好", ["bi"] = "娘", ["bj"] = "蠡", ["bk"] = "录", ["bl"] = "卵", ["bm"] = "面", ["bn"] = "女", ["bo"] = "贸", ["bp"] = "张", ["bq"] = "留", ["br"] = "努", ["bs"] = "动", ["bt"] = "群", ["bu"] = "建", ["bv"] = "奶", ["bw"] = "弱", ["bx"] = "弥", ["by"] = "云", ["bz"] = "云",
    -- 第二十三行（V 开头）
    ...
    -- 第二十五行（Z 开头）
    ["za"] = "铰", ["zb"] = "键", ["zc"] = "奕", ["zd"] = "铝", ["ze"] = "钐", ["zf"] = "锄", ["zg"] = "镦", ["zh"] = "期", ["zi"] = "玄", ["zj"] = "戮", ["zk"] = "铴", ["zl"] = "钎", ["zm"] = "钠", ["zn"] = "钓", ["zo"] = "钏", ["zp"] = "铿", ["zq"] = "亩", ["zr"] = "钗", ["zs"] = "铬", ["zt"] = "铢", ["zu"] = "戳", ["zv"] = "麾", ["zw"] = "镓", ["zx"] = "镰", ["zy"] = "链", ["zz"] = "哥",
}

-- 定义过滤器函数
function keep_short_code_first_tiger(input, env)
    -- 获取用户输入的编码
    ...
    -- 若未找到一、二级简码字符或输入非单、双字符，输出原始候选列表
    for cand in input:iter() do
        yield(cand)
    end
end
...
-- 导出过滤器函数
return keep_short_code_first_tiger
